{
  ...
  class Slide {
    constructor(el) {
      ...
      //slideshow
      this.DOM.slideshow = this.DOM.el.querySelector(".slideshow");
      // The image element.
  ...
  class Slideshow {
    ...
    showContent() {
      ...
      this.DOM.el.classList.add('slideshow__addon');
    //   this.DOM.img.classList.add('slideshow__addon');
    ...
    hideContent() {
      ...
      this.DOM.el.classList.remove('slideshow__addon');
